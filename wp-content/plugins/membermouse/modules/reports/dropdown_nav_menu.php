...
<?php } else { 
	...
	if($crntPage == MM_MODULE_REPORTING)
	{ ?>
	<a class="mm-ui-button" href="http://membermouse.uservoice.com/knowledgebase/articles/404652" target="_blank" style="position: absolute; right: 250px; top: 0px;">How to Use Reporting</a>
	<?php } ?>
