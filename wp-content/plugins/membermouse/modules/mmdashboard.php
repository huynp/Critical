   			...
   			<div class="mm-content-wrapper" style="margin-top:20px">
   				<div class="mm-content-container" style="position:relative;">
   					...
   					<ul class="spaced-list">
   						<li><a href="http://membermouse.uservoice.com" target="_blank">Support Center</a></li>
   						<?php if(MM_SupportUtils::hasEmailSupport()) { ?>
   						<li><a href="http://membermouse.uservoice.com/knowledgebase/articles/417246" target="_blank"><i class="fa fa-envelope"></i> Email us</a></li>
   						<?php } ?>
